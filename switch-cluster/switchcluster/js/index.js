...
SwitchCluster.prototype.get_html_create_users = function () {
    ...
    (0, _jquery2.default)("<button>").addClass("back-button").attr("type", "button").text("<span><-</span>").appendTo(header).on("click", _jquery2.default.proxy(this.refresh_modal, this));

    (0, _jquery2.default)('<h4 class="modal-title"><span>Add new user and send email</span></h4>').appendTo(header);
