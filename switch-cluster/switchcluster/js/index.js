...
SwitchCluster.prototype.get_html_select_cluster = function () {
    ...
    (0, _jquery2.default)('<div class="cluster-list-div"><button class="list-item-delete pure-material-button-text">X</button><div class="list-item-text">Context name</div><button class="list-item-share pure-material-button-text">Share</button><button class="list-item-select pure-material-button-text">Select</button></div><hr>').appendTo(list_div);
    (0, _jquery2.default)('<div class="cluster-list-div"><button class="list-item-delete pure-material-button-text">X</button><div class="list-item-text">Context name</div><button class="list-item-share pure-material-button-text">Share</button><button class="list-item-select pure-material-button-text">Select</button></div><hr>').appendTo(list_div);
    (0, _jquery2.default)('<div class="cluster-list-div"><button class="list-item-delete pure-material-button-text">X</button><div class="list-item-text">Context name</div><button class="list-item-share pure-material-button-text">Share</button><button class="list-item-select pure-material-button-text">Select</button></div><hr>').appendTo(list_div);
    (0, _jquery2.default)('<div class="cluster-list-div"><button class="list-item-delete pure-material-button-text">X</button><div class="list-item-text">Context name</div><button class="list-item-share pure-material-button-text">Share</button><button class="list-item-select pure-material-button-text">Select</button></div><hr>').appendTo(list_div);
    (0, _jquery2.default)('<div class="cluster-list-div"><button class="list-item-delete pure-material-button-text">X</button><div class="list-item-text">Context name</div><button class="list-item-share pure-material-button-text">Share</button><button class="list-item-select pure-material-button-text">Select</button></div><hr>').appendTo(list_div);
