...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__) {
...
var _devbridgeAutocomplete = __webpack_require__(9);

var _devbridgeAutocomplete2 = _interopRequireDefault(_devbridgeAutocomplete);

var _inlineEditJs = __webpack_require__(10);

var _inlineEditJs2 = _interopRequireDefault(_inlineEditJs);

var _configuring = __webpack_require__(14);

var _configuring2 = _interopRequireDefault(_configuring);

var _connected = __webpack_require__(15);
...
function SparkConnector() {
    ...
    this.states = {
        ...
        configuring: {
            get_html: _jquery2.default.proxy(this.get_html_configuring, this),
            buttons: {
                'Connect': {
        ...
        connecting: {
            get_html: _jquery2.default.proxy(this.get_html_connecting, this),
            hide_close: true,
            buttons: {
                'Cancel': {
        ...
        reconfigure: {
            get_html: _jquery2.default.proxy(this.get_html_reconfigure, this),
            hide_close: true,
            buttons: {}
        },
        connect_error: {
            get_html: _jquery2.default.proxy(this.get_html_connect_error, this),
            buttons: {
        ...
        connected: {
            get_html: _jquery2.default.proxy(this.get_html_connected, this),
            buttons: {
                'Go to the notebook': {
    ...
    var that = this;
    var base_url = _utils2.default.get_body_data('baseUrl');
    var config_bundles = new _config2.default.ConfigSection('sparkconnector_bundles', { base_url: base_url });
    var config_spark_options = new _config2.default.ConfigSection('sparkconnector_spark_options', { base_url: base_url });
    config_bundles.load();
    ...
    _events2.default.on('kernel_connected.Kernel', _jquery2.default.proxy(this.start_comm, this)); //Make sure there is always a comm when the kernel connects.
}

SparkConnector.prototype.filter_bundle_options = function (bundled_options) {
    var that = this;
    var filtered_options = {};
    _jquery2.default.each(bundled_options, function (name, data) {
...
SparkConnector.prototype.start_comm = function () {
    ...
    if (_namespace2.default.notebook.kernel) {
        this.comm = _namespace2.default.notebook.kernel.comm_manager.new_comm('SparkConnector', { 'msgtype': 'sparkconn-action-open' });
...
SparkConnector.prototype.back_to_config = function () {
    ...
    function restart_connection() {
        ...
        _namespace2.default.notebook.kernel.restart();
...
SparkConnector.prototype.connect = function () {
    ...
    // Add user options
    _jquery2.default.each(this.options.list_of_options, function (i, option) {
        options[option.name] = option.value;
    });

    // Add bundled options
    var that = this;
    _jquery2.default.each(this.options.bundled_options, function (i, bundle) {
        ...
        _jquery2.default.each(that.extra_options[bundle].options, function (i, option) {
...
SparkConnector.prototype.close = function () {
    ...
    if (!is_metadata_equal(this.options, this.get_notebook_metadata())) {
        _dialog2.default.modal({
            ...
            buttons: {
                ...
                'Save': {
                    class: 'btn-success size-100',
                    click: _jquery2.default.proxy(this.save_notebook_metadata, this)
                }
            }
        });
    }
    ...
    function is_metadata_equal(first, second) {
        ...
        _jquery2.default.each(first.bundled_options, function (i, option) {
            if (!(option in second)) {
                return false;
            }
        });
...
SparkConnector.prototype.open_modal = function () {
    ...
    if (this.enabled && !(this.modal && this.modal.data('bs.modal') && this.modal.data('bs.modal').isShown)) {
        ...
        this.modal.click(function (e) {
            ...
            if ((0, _jquery2.default)(e.target).is("div") && !(0, _jquery2.default)(e.target).closest('.modal-dialog').length && !that.state.hide_close) {
                that.modal.modal('hide');
            }
        });
...
SparkConnector.prototype.get_html_auth = function (config, error) {
    ...
    if (error) {
        (0, _jquery2.default)('<div/>').addClass('alert alert-dismissable alert-danger').append((0, _jquery2.default)('<button class="close" type="button" data-dismiss="alert" aria-label="Close"/>').append((0, _jquery2.default)('<span aria-hidden="true"/>').html('&times;'))).append((0, _jquery2.default)('<p/>').text(error)).appendTo(html);
    }

    (0, _jquery2.default)('<p>Before connecting to the cluster, we need to obtain a Kerberos ticket.<br>Please enter your account password.</p><p>&nbsp;</p>').appendTo(html);

    (0, _jquery2.default)('<input/>').addClass('form-control').attr('name', 'password').attr('type', 'password').appendTo(html).keypress(function (e) {
        if (e.which == _keyboard2.default.keycodes.enter) {
...
SparkConnector.prototype.get_html_configuring = function (config, error) {
    ...
    if (error) {
        (0, _jquery2.default)('<div/>').addClass('alert alert-dismissable alert-danger').append((0, _jquery2.default)('<button class="close" type="button" data-dismiss="alert" aria-label="Close"/>').append((0, _jquery2.default)('<span aria-hidden="true"/>').html('&times;'))).append((0, _jquery2.default)('<p/>').text(error.msg)).appendTo(html);
    }

    html.append(_configuring2.default.replace('{cluster_name}', this.cluster));
    ...
    _jquery2.default.each(this.extra_options, function (name, data) {
        // Add bundle checkbox and action to show options on checkbox click
        (0, _jquery2.default)('<div><input type="checkbox" ' + (that.options.bundled_options.includes(name) ? 'checked' : '') + '> Include ' + name + ' options</div>').appendTo(bundled_options).find('input').on('click', function () {
    ...
    function choose_option_name(key) {
        ...
        (0, _jquery2.default)('<label for="add_new">Add a new option</label><br>').appendTo(new_option);

        var input = (0, _jquery2.default)('<input/>').addClass('form-control').attr('name', 'add_new').attr('type', 'text').attr('value', key).attr('placeholder', 'Write the option name...').appendTo(new_option).focus().devbridgeAutocomplete({
            minChars: 1,
            ...
            if (e.keyCode == _keyboard2.default.keycodes.enter && input.val() !== "") {
                choose_option_value(input.val());
            }
        });
    };
    ...
    function choose_option_value(option_name) {
        ...
        (0, _jquery2.default)('<label>').addClass('option').attr('for', 'add_new').html(' ' + option_name).appendTo(new_option).on('click', function () {
            choose_option_name(option_name);
        }).prepend('<i class="fa fa-pencil" aria-hidden="true"> ').prepend('<i class="fa fa-cog" aria-hidden="true">').append('<br>');

        var input = (0, _jquery2.default)('<input/>').addClass('form-control').attr('name', 'add_new').attr('type', 'text').attr('placeholder', 'Write the option value... ').appendTo(new_option).focus().keydown(function (e) {
            if (e.keyCode == _keyboard2.default.keycodes.enter && input.val() !== "") {
    ...
    function show_option(option) {
        ...
        var entry = (0, _jquery2.default)('<li>').addClass('editable').append('<i class="fa fa-pencil" aria-hidden="true">').append('<i class="fa fa-cog" aria-hidden="true">').append('<i class="fa fa-exclamation-circle" aria-hidden="true">');
        ...
        var pair = (0, _jquery2.default)('<ul>').appendTo(entry);

        var elem_key = (0, _jquery2.default)('<li>').addClass('option').html(option.name).appendTo(pair);

        var elem_value = (0, _jquery2.default)('<li>').html(option.value).appendTo(pair);

        (0, _jquery2.default)('<span class="remove">×</span>').appendTo(entry).on('click', function () {
            entry.remove();
        ...
        (0, _jquery2.default)(editing_element_name).keydown(function (e) {
            if (e.keyCode == _keyboard2.default.keycodes.enter) {
                (0, _jquery2.default)(this).blur();
            }
        });

        new _inlineEditJs2.default(elem_key.get(0), {
        ...
        (0, _jquery2.default)(editing_element_value).keydown(function (e) {
            if (e.keyCode == _keyboard2.default.keycodes.enter) {
                (0, _jquery2.default)(this).blur();
            }
        });

        new _inlineEditJs2.default(elem_value.get(0), {
            onChange: function onChange(newValue, oldValue) {
                if (newValue === "") {
    ...
    function get_errors(option) {
        ...
        if (option.name === 'spark.driver.memory' && option.value.replace('g', '') > that.max_memory) {

            errors.push('Memory exceeds the container memory');
        }

        if (option.name === 'spark.driver.host' || option.name === 'spark.driver.port' || option.name === 'spark.blockManager.port' || option.name === 'spark.ui.port' || option.name === 'spark.master' || option.name === 'spark.authenticate' || option.name === 'spark.network.crypto.enabled' || option.name === 'spark.authenticate.enableSaslEncryption') {
    ...
    function highlight_errors() {
        ...
        var uniq = that.options.list_of_options.map(function (elem) {
        ...
        var duplicates = keys.filter(function (a) {
            return uniq[a] > 1;
        });

        var duplicates_bundles = [];
        _jquery2.default.each(that.options.bundled_options, function (i, bundle) {
            ...
            _jquery2.default.each(that.extra_options[bundle].options, function (i, option) {
                if (!("concatenate" in option) && keys.some(function (key) {
        ...
        _jquery2.default.each(list_elements, function (i, elem) {
            ...
            if (elem_errors.length > 0) {
                elem.entry.addClass('warning').attr('title', elem_errors.join('\n'));
            } else {
                elem.entry.removeClass('warning').removeAttr('title');
            }
        });
    }
    ...
    function fill_options() {
        _jquery2.default.each(that.options.list_of_options, function (i, option) {
            show_option(option);
        });
        _jquery2.default.each(that.options.bundled_options, function (i, option) {
    ...
    function show_bundle_option(bundle) {
        ...
        var entry = (0, _jquery2.default)('<li>').addClass('bundle').addClass('bundle_' + bundle).append('<i class="fa fa-cogs" aria-hidden="true">').appendTo(options_list);

        var pair = (0, _jquery2.default)('<ul>').appendTo(entry);

        (0, _jquery2.default)('<li>').addClass('option').html(bundle).appendTo(pair);

        _jquery2.default.each(that.extra_options[bundle].options, function (i, value) {
            var elem_value = (0, _jquery2.default)('<li>').append('<i class="fa fa-cog" aria-hidden="true">').appendTo(pair);

            var list_values = (0, _jquery2.default)('<ul>').appendTo(elem_value);
...
SparkConnector.prototype.get_html_reconfigure = function (config, error) {
    ...
    var loading = (0, _jquery2.default)('<div>').addClass('loading').appendTo(html);

    var wrapper = (0, _jquery2.default)('<div>').addClass('wrapper').appendTo(loading);

    (0, _jquery2.default)('<div>').addClass('spin').append('<i class="icon-clockwise fa fa-spin"></i>').appendTo(wrapper);
...
SparkConnector.prototype.get_html_connect_error = function (config, error) {
    ...
    // Display error
    (0, _jquery2.default)('<div/>').addClass('alert alert-danger connect-error').append((0, _jquery2.default)('<p/>').addClass("header").text('Error while connecting to Spark cluster')).append((0, _jquery2.default)('<p/>').text(error)).appendTo(html);

    var that = this;
    var logs_wrapper = (0, _jquery2.default)('<div>').addClass('log-connect-error').appendTo(html);

    logs_wrapper.append((0, _jquery2.default)('<p/>').text("These are the logs of the failed application.")).append(this.connecting_logs);
...
SparkConnector.prototype.get_html_connecting = function (config, error) {
    ...
    var logs_wrapper = (0, _jquery2.default)('<div>').addClass('log-connecting').appendTo(html);

    this.connecting_logs = (0, _jquery2.default)('<pre>').addClass('logs').appendTo(logs_wrapper);
};
...
SparkConnector.prototype.get_html_connected = function (config, error) {
    ...
    var template = _connected2.default.replace('{spark_version}', that.spark_version).replace('{cluster_name}', that.cluster);
    html.html(template);

    if (config && config.sparkmetrics) {
        var metricsURL = (0, _jquery2.default)('<a>').attr('href', config.sparkmetrics).attr('target', '_blank').text('here');
        html.find('.success-metrics-text').text('Spark Metrics are available ').append(metricsURL);
    }

    if (config && config.sparkhistoryserver) {
        var historyserverURL = (0, _jquery2.default)('<a>').attr('href', config.sparkhistoryserver).attr('target', '_blank').text('here');
        html.find('.success-history-text').text('Spark History Server is available ').append(historyserverURL);
    }

    html.find('.success-show-logs-action').attr('href', 'javascript:').text('show/hide').on('click', function () {
        that.send({
...
SparkConnector.prototype.switch_state = function (new_state, config, error) {
    ...
    if (this.modal) {
        ...
        _jquery2.default.each(new_state.buttons, function (name, options) {
            (0, _jquery2.default)('<button>').addClass('btn btn-default btn-sm').addClass(options.class).attr('data-dismiss', 'modal').on('click', options.click).text(name).appendTo(footer);
        });
...
SparkConnector.prototype.get_notebook_metadata = function () {
    ...
    if (_namespace2.default.notebook.metadata && _namespace2.default.notebook.metadata.sparkconnect) {
        ...
        to_return = _jquery2.default.extend(true, to_return, _namespace2.default.notebook.metadata.sparkconnect);
    }
...
SparkConnector.prototype.save_notebook_metadata = function () {
    ...
    var sparkconnect_metadata = _jquery2.default.extend(true, {}, this.options);

    console.log("SparkConnector save configs");

    var metadata = _namespace2.default.notebook.metadata;
    metadata.sparkconnect = sparkconnect_metadata;
    _namespace2.default.notebook.metadata = metadata;
    _namespace2.default.notebook.save_checkpoint();
};
...
module.exports = "<p>You are going to connect to:<br><span class=cluster-name>{cluster_name}</span></p><p>&nbsp;</p> <p>You can configure the following <a href=https://spark.apache.org/docs/latest/configuration#available-properties target=_blank title=\"SparkConf options\">options</a>. <br>variables can be used via {ENV_VAR_NAME}.</p><br> <div class=new-option> </div> <div id=bundled-options> <br><label>Bundled configurations</label><br> <p>These options will be overwritten by non-bundled options if specified</p> </div> <p>&nbsp;</p> <h2>Selected configuration</h2> <ul class=spark-options> </ul>";

/***/ }),
/* 15 */
/***/ (function(module, exports) {

module.exports = "<p class=success><i class=icon-checked></i>You are connected to <b>{cluster_name}</b></p> <p><b>The following variables were instantiated</b></p> <ul class=variables> <li>sc = <a href=https://spark.apache.org/docs/latest/api/python/pyspark.html#pyspark.SparkContext target=_blank>SparkContext</a></li> <li>spark = <a href=https://spark.apache.org/docs/latest/api/python/pyspark.sql.html#pyspark.sql.SparkSession target=_blank>SparkSession</a></li> </ul> <p><b>Connection details</b></p> <ul class=variables> <li>Spark version is {spark_version}</li> <li class=success-history-text>Spark History is not available</li> <li class=success-metrics-text>Spark Metrics are not available (requires enabled bundle)</li> <li>Spark driver logs of the running application <a class=success-show-logs-action></a></li> </ul> <div class=log-connected> <pre class=logs>Waiting for the remaining job to finish to retrieve the logs..</pre> </div>";
